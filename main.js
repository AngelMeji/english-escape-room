document.addEventListener("DOMContentLoaded", () => {
    ...
    function loadRoom(index) {
        ...
        if (index === 0 || index === 1) {
            // Start Screen & Room 1 & Room 2: Dungeon Theme
            body.classList.add("theme-dungeon");
        } else if (index === 2) {
    ...
    function handleCorrectAnswer() {
        ...
        // Iniciar oscurecimiento (1s después de que se empieza a abrir la puerta)
        setTimeout(() => {
            transitionOverlay.style.opacity = "1";
        }, 1500);

        // Cambiar de habitación y aclarar pantalla
        setTimeout(() => {
            nextRoom();
            // Esperamos un momento breve para que el usuario no vea el cambio de golpe
            setTimeout(() => {
